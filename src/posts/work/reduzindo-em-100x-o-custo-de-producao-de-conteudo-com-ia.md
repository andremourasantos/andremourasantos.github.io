...
![fluxograma](../../assets/photos/reduzindo-em-100x-o-custo-de-producao-de-conteudo-com-ia-foto-1.png)
...
![Comparação dentre tempos estimados para produção: usar calendários para demonstrar diferença de forma didática](../../assets/photos/reduzindo-em-100x-o-custo-de-producao-de-conteudo-com-ia-foto-2.png)
...
![fluxo de trabalho antes, com pipeline extensa, e depois, com duas pipelines reduzidas](../../assets/photos/reduzindo-em-100x-o-custo-de-producao-de-conteudo-com-ia-foto-3.png)
...
![fluxograma apresentando funcionamento das automações na pipeline de produção de artigos. O diagrama deve destacar o que aparecia no CRM para o operador concluir, quais as consequências de concluir uma determinada tarefa e o tempo média de conclusão dessas.](../../assets/photos/reduzindo-em-100x-o-custo-de-producao-de-conteudo-com-ia-foto-4.png)

![](../../assets/photos/reduzindo-em-100x-o-custo-de-producao-de-conteudo-com-ia-foto-5.png)

> Inclusive, se você souber como tirar capturas de tela de alta qualidade dos fluxo do Make.com, [me mostra como](https://api.whatsapp.com/send/?phone=5541935009236&text=Oi,%20eu%20sei%20tirar%20prints%20de%20alta%20qualidade%20dos%20fluxos%20no%20Make.com!)!
...
![diagrama apresentando fluxograma de automações na pipeline de produção de artigos. O diagrama deve destacar que a automação funciona em via de mão dupla: ou seja, quando o sistema do prestador de serviço é atualizado, o CRM também é, e vice-versa.](../../assets/photos/reduzindo-em-100x-o-custo-de-producao-de-conteudo-com-ia-foto-6.png)

![](../../assets/photos/reduzindo-em-100x-o-custo-de-producao-de-conteudo-com-ia-foto-7.png)

> À época que essa automação foi implementada, não utilizávamos IA no fluxo de trabalho.
...
> Testamos diversas IAs, como as famílias *DeepSeek*, *GPT-4o*, *GPT-4.5* e a família do *Gemini 2.5* (à época, em pré-visualização). Acabamos por escolher os modelos *2.5 Flash* e *2.5 Pro*, do *Gemini*, pela capacidade de [seguir os prompts consistentemente](/portfolio/estrutura-de-prompt-para-ia).
...
![](../../assets/photos/reduzindo-em-100x-o-custo-de-producao-de-conteudo-com-ia-foto-8.png)
...
![](../../assets/photos/reduzindo-em-100x-o-custo-de-producao-de-conteudo-com-ia-foto-9.png)
