...
if (window.location.href.includes('?redirecionamento=idioma')) {var instancia = 1; mostrarNotificacao(instancia)
} else {}
...
function mostrarNotificacao(tipo){
    ...
    /* ANTIGO CÓDIGO PARA ADICIONAR ELEMENTO HTML (FUNCIONAVA, MAS BUGAVA O JS DEPOIS DE EXECUTADO ─ O NOVO CÓDIGO ALTERA O DOM, POR ISSO DEVE TER FUNCIONADO, EU IMAGINO ISSO)
