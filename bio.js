...
document.getElementById("botaobioCompartilhar").addEventListener("click", function(){
...
document.getElementById("fecharbiopopup0").addEventListener("click", function(){
    document.querySelector("#biopopup0").style.display = "none";
    document.querySelector("#biopopup1").style.display = "flex";
});

document.getElementById("fecharbiopopup1").addEventListener("click", function(){
